...
export default function TwoWayBinding() {
    ...
    const [newProduct, setNewProduct] = useState({ Name: '', Price: '', City: '', Stock: false });

    // function (Store Product)
    function handleProductStore() {
        ...
        <div className="container-fluid">
            <div className="row">
                <div className="col-3">
                    ...
                    <button onClick={handleProductStore} className="btn btn-primary w-100">Register</button>
